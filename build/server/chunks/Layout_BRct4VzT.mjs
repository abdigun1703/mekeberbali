import { a as createComponent, m as maybeRenderHead, d as addAttribute, b as renderTemplate, c as createAstro, r as renderComponent, g as renderScript, e as renderHead, f as renderSlot } from './astro/server_2Hbhgjc_.mjs';
import 'kleur/colors';
import 'clsx';
import { g as getCollection } from './_astro_content_Cb24s3FI.mjs';
/* empty css                         */
/* empty css                          */
...
const $$MainMenu = createComponent(($$result, $$props, $$slots) => {
  ...
  return renderTemplate`${maybeRenderHead()}<div> <button id="navbarToggler" class="absolute right-4 top-1/2 block -translate-y-1/2 border-2 border-gray-800 rounded-lg px-3 py-[6px] ring-primary lg:hidden"> <span class="relative my-[6px] block h-[2px] w-[30px] bg-gray-800 dark:bg-white"></span> <span class="relative my-[6px] block h-[2px] w-[30px] bg-gray-800 dark:bg-white"></span> <span class="relative my-[6px] block h-[2px] w-[30px] bg-gray-800 dark:bg-white"></span> </button> <nav id="navbarCollapse" class="absolute right-4 top-full hidden w-[90%] mx-auto max-w-[380px] rounded-lg bg-white dark:bg-gray-800 py-5 shadow-lg lg:static lg:block lg:w-full lg:max-w-full lg:bg-transparent dark:lg:bg-transparent lg:py-0 xl:px-4 lg:shadow-none 2xl:px-6"> <ul class="block lg:flex xl:ml-5"> ${menuitems.map((item, index) => {
    ...
    if (item.children) {
      return renderTemplate`<li class="submenu-item group relative"> <a${addAttribute(item.path, "href")}${addAttribute(` ${index}
                          ...
                          `, "class")}> ${item.title} <svg class="fill-current ml-2" width="16" height="20" viewBox="0 0 16 20" fill="none" xmlns="http://www.w3.org/2000/svg"> <path d="M7.99999 14.9C7.84999 14.9 7.72499 14.85 7.59999 14.75L1.84999 9.10005C1.62499 8.87505 1.62499 8.52505 1.84999 8.30005C2.07499 8.07505 2.42499 8.07505 2.64999 8.30005L7.99999 13.525L13.35 8.25005C13.575 8.02505 13.925 8.02505 14.15 8.25005C14.375 8.47505 14.375 8.82505 14.15 9.05005L8.39999 14.7C8.27499 14.825 8.14999 14.9 7.99999 14.9Z"></path> </svg> </a> <div class="submenu relative top-full left-0 hidden w-[250px] rounded-sm bg-white dark:bg-dark-2 p-4 transition-[top] duration-300 group-hover:opacity-100 lg:invisible lg:absolute lg:top-[110%] lg:block lg:opacity-0 lg:shadow-lg lg:group-hover:visible lg:group-hover:top-full"> ${item.children.map((childItem) => (
        // Changed variable name to avoid conflict
        renderTemplate`<a${addAttribute(childItem.path, "href")} class="block rounded py-[10px] px-4 text-sm text-body-color dark:text-dark-6 hover:text-primary dark:hover:text-primary"> ${childItem.title} </a>`
      ))} </div> </li>`;
    }
  })} <div class="ml-3 flex md:hidden"> <a href="#" class="bg-emerald-400 py-2 px-5 rounded-lg text-white text-sm">Hari Libur Nasional</a> </div> </ul> </nav> </div>`;
}, "C:/Users/User/Documents/program/astronot/myboy/src/components/MainMenu.astro", void 0);
...
const $$Astro$2 = createAstro("https://www.mekeber.com");
const $$Header = createComponent(($$result, $$props, $$slots) => {
  const Astro2 = $$result.createAstro($$Astro$2, $$props, $$slots);
  Astro2.self = $$Header;
  const isHomePage = Astro2.url.pathname === "/";
  return renderTemplate`${maybeRenderHead()}<header class="ud-header absolute top-0 left-0 z-40 flex w-full items-center bg-transparent"> <div class="max-w-[1240px] container mx-auto"> <div class="relative flex items-center justify-between"> ${renderComponent($$result, "LogoMenu", $$LogoMenu, {})} <div class="flex w-full items-center justify-between px-4"> ${renderComponent($$result, "MainMenu", $$MainMenu, { "menuitems": menuitems, "homePage": isHomePage })} ${renderComponent($$result, "RightMenu", $$RightMenu, { "homePage": isHomePage })} </div> </div> </div> </header>`;
}, "C:/Users/User/Documents/program/astronot/myboy/src/components/layout/Header.astro", void 0);

const $$BackToTop = createComponent(($$result, $$props, $$slots) => {
  return renderTemplate`<!-- ====== Back To Top Start -->${maybeRenderHead()}<a href="javascript:void(0)" class="back-to-top fixed bottom-8 right-8 left-auto z-[999] hidden h-10 w-10 items-center justify-center rounded-md bg-primary text-white shadow-md transition duration-300 ease-in-out hover:bg-dark"> <span class="mt-[6px] h-3 w-3 rotate-45 border-t border-l border-white"></span> </a> <!-- ====== Back To Top End -->`;
}, "C:/Users/User/Documents/program/astronot/myboy/src/components/layout/BackToTop.astro", void 0);
...
const $$ClientRouter = createComponent(($$result, $$props, $$slots) => {
  ...
  return renderTemplate`<meta name="astro-view-transitions-enabled" content="true"><meta name="astro-view-transitions-fallback"${addAttribute(fallback, "content")}>${renderScript($$result, "C:/Users/User/Documents/program/astronot/myboy/node_modules/astro/components/ClientRouter.astro?astro&type=script&index=0&lang.ts")}`;
}, "C:/Users/User/Documents/program/astronot/myboy/node_modules/astro/components/ClientRouter.astro", void 0);

const homepage = {"title":"Mekeber Bali","description":"Situs lowongan pekerjaan, bisnis, klinik"};
const config = {
  homepage};
...
const $$Layout = createComponent(($$result, $$props, $$slots) => {
  ...
  Astro2.self = $$Layout;
  const siteName = config.homepage.title;
  const siteDescription = config.homepage.description;
  const pageDescription = `${siteDescription} | ${siteName}`;
  const { description, title = "Mekeber Bali", image, canonical } = Astro2.props;
  return renderTemplate`<html lang="en"> <head><meta charset="utf-8"><meta name="viewport" content="width=device-width"><!-- Favicons --><link rel="apple-touch-icon" sizes="180x180" href="/apple-touch-icon.png"><link rel="icon" type="image/png" sizes="32x32" href="/favicon-32x32.png"><link rel="icon" type="image/png" sizes="16x16" href="/favicon-16x16.png"><link rel="manifest" href="/site.webmanifest"><!-- PWA Settings --><meta name="theme-color" content="#ffffff"><meta name="apple-mobile-web-app-capable" content="yes"><meta name="apple-mobile-web-app-status-bar-style" content="black-translucent"><!-- Canonical --><link rel="canonical"${addAttribute(canonical || Astro2.url.href, "href")} item-prop="url"><meta name="generator"${addAttribute(Astro2.generator, "content")}><meta name="description"${addAttribute(description || pageDescription, "content")}><meta property="og:image"${addAttribute(image, "content")}><meta property="twitter:image"${addAttribute(image, "content")}><meta name="twitter:image:alt"${addAttribute(title || "Thumbnail situs Mekeber", "content")}><title>${title}</title>${renderHead()}</head> <body> ${renderComponent($$result, "Header", $$Header, {})} <!-- <Header client:load /> --> <main> ${renderComponent($$result, "ClientRouter", $$ClientRouter, {})} ${renderSlot($$result, $$slots["default"])} </main> ${renderComponent($$result, "Footer", $$Footer, {})} ${renderComponent($$result, "BackToTop", $$BackToTop, {})}  ${renderScript($$result, "C:/Users/User/Documents/program/astronot/myboy/src/layouts/Layout.astro?astro&type=script&index=0&lang.ts")} </body> </html>`;
}, "C:/Users/User/Documents/program/astronot/myboy/src/layouts/Layout.astro", void 0);
